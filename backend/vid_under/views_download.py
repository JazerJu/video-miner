...
MODEL_GROUPS: dict[str, ModelGroup] = {
    ...
    "wemm-embedding": {
        ...
        "description": "Video + text embedding for find_clips clip search (ONNX, needs onnxruntime-gpu 1.30+, no torch)",
        "files": [
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/decoder/model.onnx.data",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/decoder/model.onnx.data",
                "size": 1931932672,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/embedding/model.onnx.data",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/embedding/model.onnx.data",
                "size": 1270224896,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/vision_encoder/model.onnx.data",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/vision_encoder/model.onnx.data",
                "size": 183700480,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/tokenizer.json",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/tokenizer.json",
                "size": 19990378,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/decoder/model.onnx",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/decoder/model.onnx",
                "size": 1198966,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/vision_encoder/model.onnx",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/vision_encoder/model.onnx",
                "size": 702983,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/LICENSE",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/LICENSE",
                "size": 24546,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/embedding/model.onnx",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/embedding/model.onnx",
                "size": 4764,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/config.json",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/config.json",
                "size": 3541,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/README.md",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/README.md",
                "size": 2128,
            },
            {
                "repo_path": "wemm/WeMM-Embedding-4B-onnx-nf4/tokenizer_config.json",
                "local_path": "wemm/WeMM-Embedding-4B-onnx-nf4/tokenizer_config.json",
                "size": 1142,
            },
        ],
    },
